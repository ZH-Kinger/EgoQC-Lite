...
button,input,textarea,select{font:inherit;color:inherit;border:1px solid var(--line);background:transparent;padding:8px 10px}button{cursor:pointer;transition:transform 90ms ease,border-color 90ms ease,background-color 90ms ease}button:hover:not(:disabled){border-color:var(--ink)}button:active:not(:disabled){transform:translateY(1px)}button:focus-visible,input:focus-visible,textarea:focus-visible,select:focus-visible{outline:2px solid var(--blue);outline-offset:2px}button:disabled{opacity:.38;cursor:not-allowed}button.active{background:var(--ink);color:var(--card);border-color:var(--ink)}
	...
	.review-nav{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 0 4px}.review-position,.preload-status{color:var(--muted);font:12px ui-monospace,monospace}.preload-status{margin-left:10px}.review-nav[hidden]{display:none}
	.case{display:grid;grid-template-columns:minmax(620px,1.45fr) minmax(480px,.9fr);gap:30px;padding:28px 0 34px;border-bottom:1px solid var(--line);align-items:start;scroll-margin-top:142px}.media-panel{min-width:0;position:sticky;top:146px}.media-shell{position:relative;width:100%;margin:auto;aspect-ratio:16/9;background:#111;display:grid;place-items:center;overflow:hidden}.media-shell[data-display-size="720"]{max-width:1280px}.media-shell[data-display-size="540"]{max-width:960px}.media-shell[data-display-size="360"]{max-width:640px}.media-shell video{display:block;width:100%;height:100%;object-fit:contain;background:#111}.media-status{position:absolute;left:12px;top:12px;padding:5px 8px;background:rgba(17,17,17,.82);color:#fff;font-size:12px;pointer-events:none}.media-status[hidden]{display:none}.video-controls{display:flex;align-items:center;gap:2px;min-height:42px;padding:5px 6px;background:#1d1d1a;color:#f8f8f3;border-top:1px solid #3a3a35}.video-controls button,.video-controls select{height:32px;min-width:32px;padding:5px 8px;border:0;color:#e8e8e1;background:transparent}.video-controls button:hover:not(:disabled),.video-controls select:hover{background:#32322d}.video-controls .transport-main{font-size:15px}.video-progress{flex:1;min-width:150px;height:22px;margin:0 7px;padding:0;accent-color:#deded6;border:0;background:transparent;cursor:pointer}.video-time,.source-resolution{font:11px ui-monospace,monospace;white-space:nowrap}.video-time{min-width:86px;color:#deded6}.source-resolution{color:#92928a}.overlay-note{margin:8px 0 0!important;padding:7px 9px;border-left:2px solid #9a6a12;background:#e9e9e2;color:#575750!important;font-size:12px}.head{display:flex;justify-content:space-between;gap:12px}.eyebrow{font:11px ui-monospace,monospace;color:var(--muted);word-break:break-all}h2{font-size:21px;margin:5px 0}.duration{font:700 12px ui-monospace,monospace;color:var(--red)}
...
dl{display:grid;grid-template-columns:92px 1fr;margin:18px 0;border-top:1px solid var(--line)}dt,dd{padding:7px 0;margin:0;border-bottom:1px solid var(--line)}dt{color:var(--muted)}dd{font:12px ui-monospace,monospace}.actions,.media-tabs{display:flex;gap:7px;margin:13px 0}.actions{align-items:center;flex-wrap:wrap}.actions .media-tabs{margin:0}.action-divider{width:1px;height:28px;background:var(--line)}.claim{background:var(--ink);color:var(--card);border-color:var(--ink)}.choices{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin:13px 0}.choices button[data-decision=confirmed].selected{background:var(--red);color:#fff}.choices button[data-decision=false_positive].selected{background:var(--green);color:#fff}.choices button[data-decision=unsure].selected{background:var(--ink);color:#fff}label{display:grid;gap:6px;color:var(--muted)}textarea{min-height:80px;resize:vertical}.message{min-height:21px;margin-top:8px;color:var(--muted)}.message.error{color:var(--red)}
	.gold{margin:16px 0;padding:14px;border:1px solid var(--line);background:#f2f2ec}.gold h3{font-size:13px;margin:0 0 8px}.gold p{margin:5px 0;color:var(--muted)}.judge-guide{display:grid;gap:5px;margin:11px 0;padding:10px;background:var(--card);border-left:3px solid var(--blue)}.judge-guide strong{font-size:13px}.judge-guide span{color:var(--muted);font-size:12px;line-height:1.5}.machine-verdict{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 0;border-bottom:1px solid var(--line)}.machine-verdict span{color:var(--muted)}.machine-verdict strong{font-size:16px}.problem-title{margin-top:13px!important}.problem-list{display:grid;gap:7px;margin-top:8px}.problem{padding:9px 10px;border-left:3px solid var(--red);background:var(--card)}.problem strong{font-size:13px}.problem p{margin:3px 0}.problem small{display:block;color:var(--blue);font:11px/1.45 ui-monospace,monospace}.problem-example{display:grid;grid-template-columns:70px 1fr;gap:5px 8px;margin-top:7px;padding-top:7px;border-top:1px solid var(--line);font-size:11px;line-height:1.45}.problem-example b:first-child{color:var(--red)}.problem-example b:nth-of-type(2){color:var(--green)}.problem-example span{color:var(--muted)}.seek-section{margin-top:12px;padding-top:11px;border-top:1px solid var(--line)}.seek-section>span{display:block;color:var(--muted);font-size:12px}.seek-points{display:flex;flex-wrap:wrap;gap:6px;margin-top:7px}.seek-points button{padding:5px 7px;background:var(--card);font:11px ui-monospace,monospace}.media-tabs button.active,.issue-row button.selected{background:var(--ink);color:var(--card);border-color:var(--ink)}.quick-actions{display:grid;grid-template-columns:minmax(150px,1fr) minmax(150px,1fr) auto;gap:7px;margin-top:13px}.quick-confirm{background:var(--ink);color:var(--card);border-color:var(--ink);font-weight:650}.correction{margin-top:14px;padding-top:13px;border-top:1px solid var(--line)}.correction[hidden]{display:none}.correction-head{display:flex;align-items:start;justify-content:space-between;gap:12px;margin-bottom:8px}.correction-head p{margin:0;max-width:45ch}.issue-row{display:grid;grid-template-columns:minmax(120px,1fr) repeat(3,80px);gap:5px;align-items:center;margin:6px 0}.issue-row span{font-size:12px}.save-correction{width:100%;margin-top:10px}.note-label{margin-top:12px}.feed-sentinel{padding:22px;text-align:center;color:var(--muted);font:12px ui-monospace,monospace}.feed-sentinel[hidden]{display:none}
	@media(max-width:1180px){.case{grid-template-columns:1fr}.media-panel{position:static}.media-shell{max-height:72vh}.case>section{max-width:none}}
...
<script>
	...
	const feedBatchSize=8;
	const state={events:[],filter:'queue',kindFilter:'all',focusIndex:0,renderLimit:feedBatchSize,displaySize:localStorage.getItem('egoqc-display-size')||'fit',tokens:{},drafts:{},structured:savedStructured,views:{},me:null};
	const mediaCache=new Map(),mediaInflight=new Map(),mediaCacheLimit=12;
...
const issueExamples={instantaneous_velocity_outlier:['网格在一两帧内跳出手掌数厘米，随后立刻回到真实手上。','真实手和网格同步快速移动，并且原视频同时出现运动模糊。'],joint_rotation_jitter:['真实手指基本不动，但网格指节连续抽动、反折或穿过相邻手指。','真实手指确实连续屈伸，网格变化方向和时机一致。'],position_jitter:['真实手腕稳定，整只 MANO 网格却围绕手腕来回晃动。','头部相机晃动导致整个画面、真实手和网格一起移动。'],temporal_spike:['某一帧网格突然飞走或翻面，前后两帧都正常。','真实手发生一次快速击打或抓取，原视频也能看到对应位移。'],wrist_rotation_jitter:['真实手掌朝向没变，网格手掌短时间反复翻面。','真实手确实翻腕，网格跟随同方向转动。'],camera_jitter:['背景静止但重建中的相机或双手坐标同时突然跳变。','佩戴者真实快速转头，整个原视频画面连续变化。'],mask_flicker:['真实手清楚可见，网格却隔帧消失又出现。','手被物体完全遮挡或离开画面时，网格同步消失。'],pose_freeze_candidate:['真实手指持续活动，网格保持同一手形只做整体平移。','真实手本来就在保持固定手形移动。'],beta_drift:['同一人的网格手掌或手指长度在片段中缓慢变粗、变长。','透视变化让画面中的手变大，但网格仍贴合真实轮廓。']};
function issueExample(code){return issueExamples[code]||['真实手运动连续，但网格单独出现明显跳变、漂移或错误形变。','原视频中的真实动作与网格变化在时间和方向上保持一致。']}
...
function machineTierLabel(e){return {bronze:'建议返工',silver:'建议人工复核',gold:'建议通过'}[e.metrics?.baseline_tier]||'已有机器结论'}
	function overlayState(e){const metrics=e.metrics||{};if(metrics.annotated_clip_path)return {available:true,label:'MANO 叠加',note:''};const unavailable=(metrics.unavailable_gold_labels||[]).includes('mano_overlay_drift')||metrics.parent_episode_index==null;return unavailable?{available:false,label:'仅 RGB',note:'源数据没有可投影的 MANO 标注，当前只能复核画面质量。'}:{available:false,label:'MANO 未生成',note:'该样本具备 LeRobot episode 信息，但叠加视频尚未生成，暂不能判断 mesh 拟合。'}}
	function mediaControls(e){if(!isGold(e))return '';const view=state.views[e.event_id]||'raw',overlay=overlayState(e);return `<span class="action-divider" aria-hidden="true"></span><div class="media-tabs" aria-label="视频视图"><button data-view="raw" class="${view==='raw'?'active':''}">原视频</button><button data-view="annotated" class="${view==='annotated'?'active':''}" ${overlay.available?'':`disabled title="${esc(overlay.note)}"`}>${esc(overlay.label)}</button></div>`}
	function goldPanel(e){if(!isGold(e))return '';const issues=e.metrics?.issue_codes||[],overlay=overlayState(e);const problems=issues.length?issues.map(code=>{const evidence=issueEvidence(e,code),examples=issueExample(code);return `<div class="problem"><strong>${esc(issueLabel(e,code))}</strong><p>${esc(issueDescription(e,code))}</p>${evidence?`<small>机器证据：${esc(evidence)}</small>`:''}<div class="problem-example"><b>明显有问题</b><span>${esc(examples[0])}</span><b>通常没问题</b><span>${esc(examples[1])}</span></div></div>`}).join(''):'<div class="problem"><strong>没有底层规则说明</strong><p>当前只命中 episode 聚合规则，需要结合完整视频人工判断。</p></div>';return `<div class="gold" data-role="gold"><h3>机器初筛结果</h3><div class="machine-verdict"><span>机器认为</span><strong>${esc(machineTierLabel(e))}</strong></div><div class="judge-guide"><strong>怎样判断标注对不对</strong><span>先看原视频里的真实手，再切到 MANO 叠加。真实手运动正常，但网格出现抖动、漂移、穿模、翻转或消失，说明标注有问题；两者同步运动通常不是标注错误。</span></div>${overlay.note?`<p class="overlay-note">${esc(overlay.note)}</p>`:''}<h3 class="problem-title">机器希望你重点检查</h3><div class="problem-list">${problems}</div>${sampleFrames(e)}<div class="quick-actions"><button class="quick-confirm" data-quick="confirm">标注有问题</button><button data-action="edit-correction">部分或全部没问题</button><button data-quick="unsure">看不出来</button></div><div class="correction" data-role="correction" hidden><div class="correction-head"><div><h3>逐项确认</h3><p>只需要判断画面是否支持机器指出的问题。</p></div><button data-action="cancel-correction">收起</button></div><div class="issue-list">${issues.map(code=>`<div class="issue-row" data-issue="${esc(code)}"><span>${esc(issueLabel(e,code))}</span>${[['confirmed','有问题'],['false_positive','没问题'],['unsure','看不出']].map(([v,l])=>`<button data-issue-verdict="${v}">${l}</button>`).join('')}</div>`).join('')}</div><button class="save-correction" data-action="save-correction">提交逐项判断</button></div></div>`}
	function card(e){const note=state.drafts[e.event_id]??e.note??'';const heading=isGold(e)?'标注质量复核':(e.error_label||title(e.kind));const choices=isGold(e)?'':`<div class="choices">${['confirmed','false_positive','unsure'].map(d=>`<button data-decision="${d}">${decisionLabel(d,e)}</button>`).join('')}</div>`;const view=isGold(e)?state.views[e.event_id]||'raw':'primary',technicalKind=isGold(e)?'':`<code>${esc(e.kind)}</code>`;const displayOptions=[['fit','适应'],['720','720p'],['540','540p'],['360','360p']].map(([value,label])=>`<option value="${value}" ${state.displaySize===value?'selected':''}>${label}</option>`).join('');return `<article class="case" data-id="${esc(e.event_id)}"><div class="media-panel"><div class="media-shell" data-display-size="${esc(state.displaySize)}"><video preload="none" playsinline data-media-view="${view}"></video><span class="media-status">接近屏幕时自动加载</span></div><div class="video-controls" aria-label="视频播放控制"><button class="transport-main" type="button" data-video-action="toggle" aria-label="播放" title="播放 / 暂停">▶</button><button type="button" data-video-action="back" aria-label="后退 1 秒" title="后退 1 秒">-1</button><button type="button" data-video-action="forward" aria-label="前进 1 秒" title="前进 1 秒">+1</button><span class="video-time">00:00 / --:--</span><input class="video-progress" type="range" min="0" max="1000" value="0" step="1" aria-label="视频进度"><button type="button" data-video-action="mute" aria-label="静音">声音</button><select data-video-rate aria-label="播放速度" title="播放速度"><option value="0.5">0.5×</option><option value="1" selected>1×</option><option value="1.5">1.5×</option><option value="2">2×</option></select><select data-display-resolution aria-label="显示分辨率" title="只改变显示尺寸，不转码">${displayOptions}</select><span class="source-resolution">--×--</span><button type="button" data-video-action="fullscreen" aria-label="全屏" title="全屏">⛶</button></div></div><section><div class="head"><div><div class="eyebrow">${esc(e.video_id)}</div><h2 data-role="title">${esc(heading)}</h2></div><span class="duration">${Number(e.duration_s).toFixed(2)}s</span></div><span data-role="state" class="badge ${esc(e.state)}"></span><div class="taxonomy" data-role="taxonomy"><span data-role="category"></span><span data-role="severity" class="severity"></span>${technicalKind}</div><dl><dt>${isGold(e)?'审核片段':'异常区间'}</dt><dd>${Number(e.start_s).toFixed(2)}-${Number(e.end_s).toFixed(2)}s</dd><dt>当前结论</dt><dd data-role="decision"></dd><dt>版本</dt><dd data-role="version"></dd></dl><div class="actions"></div>${goldPanel(e)}${choices}<label class="note-label">补充说明（可选）<textarea placeholder="仅在需要时填写画面、时间点或判断依据">${esc(note)}</textarea></label><div class="message"></div></section></article>`}
function isVisible(e){const reviewerName=state.me?.authenticated?state.me.user_id:reviewer.value.trim();const stateMatch=state.filter==='all'||e.state===state.filter||(state.filter==='queue'&&(e.state==='pending'||(e.state==='claimed'&&e.claimed_by===reviewerName)));return stateMatch&&(state.kindFilter==='all'||e.kind===state.kindFilter)}
	...
	function renderedRows(events=state.events){return visibleRows(events).slice(0,state.renderLimit)}
	function updateNavigation(){const rows=visibleRows(),shown=Math.min(state.renderLimit,rows.length),nav=document.querySelector('#review-nav'),sentinel=document.querySelector('#feed-sentinel');nav.hidden=!rows.length;sentinel.hidden=!rows.length||shown>=rows.length;if(!rows.length)return;state.focusIndex=Math.max(0,Math.min(state.focusIndex,rows.length-1));document.querySelector('#review-position').textContent=`已载入 ${shown} / ${rows.length} 条，向下滚动自动加载`;sentinel.textContent=shown>=rows.length?'已加载全部':`继续向下滚动，下一批 ${Math.min(feedBatchSize,rows.length-shown)} 条`}
	function mediaKey(e,view){return `${e.event_id}:${view}`}
	function mediaEndpoint(e,view){return `/api/review/media/${encodeURIComponent(e.event_id)}?view=${view}`}
	function cacheMedia(key,blob){const previous=mediaCache.get(key);if(previous)URL.revokeObjectURL(previous.url);const item={url:URL.createObjectURL(blob),bytes:blob.size};mediaCache.set(key,item);let attempts=0;while(mediaCache.size>mediaCacheLimit&&attempts++<mediaCache.size+1){const active=new Set(Array.from(document.querySelectorAll('video')).map(video=>video.dataset.mediaKey).filter(Boolean)),oldest=mediaCache.keys().next().value;if(active.has(oldest)){const keep=mediaCache.get(oldest);mediaCache.delete(oldest);mediaCache.set(oldest,keep);continue}const removed=mediaCache.get(oldest);URL.revokeObjectURL(removed.url);mediaCache.delete(oldest)}return item}
	function preloadMedia(e,view){const key=mediaKey(e,view);if(mediaCache.has(key))return Promise.resolve(mediaCache.get(key));if(mediaInflight.has(key))return mediaInflight.get(key).promise;const controller=new AbortController(),promise=fetch(mediaEndpoint(e,view),{signal:controller.signal}).then(response=>{if(!response.ok)throw new Error(`预加载失败 HTTP ${response.status}`);return response.blob()}).then(blob=>cacheMedia(key,blob)).finally(()=>{if(mediaInflight.get(key)?.promise===promise)mediaInflight.delete(key)});mediaInflight.set(key,{controller,promise});return promise}
	function setMediaSource(video,e,view,position=0){const key=mediaKey(e,view),apply=item=>{if(video.dataset.mediaKey!==key)return;video.src=item?.url||mediaEndpoint(e,view);video.load();video.addEventListener('loadedmetadata',()=>{video.currentTime=Math.min(position,video.duration||position)},{once:true})};video.dataset.mediaKey=key;video.dataset.mediaView=view;if(mediaCache.has(key)){const item=mediaCache.get(key);mediaCache.delete(key);mediaCache.set(key,item);apply(item)}else if(mediaInflight.has(key)){video.removeAttribute('src');video.load();mediaInflight.get(key).promise.then(apply).catch(error=>{if(error.name!=='AbortError')apply(null)})}else apply(null)}
	function preloadNeighbors(){const rows=visibleRows();if(!rows.length)return;const current=rows[state.focusIndex],currentView=state.views[current.event_id]||(isGold(current)?'raw':'primary'),targets=[];if(isGold(current)){const alternate=currentView==='annotated'?'raw':'annotated';if(alternate==='raw'||overlayState(current).available)targets.push([current,alternate])}for(const offset of [1,2,3,4,5,-1,-2]){const event=rows[state.focusIndex+offset];if(event)targets.push([event,state.views[event.event_id]||(isGold(event)?'raw':'primary')])}const unique=new Map(targets.map(([event,view])=>[mediaKey(event,view),[event,view]])),desired=new Set(unique.keys()),activeKeys=new Set(Array.from(document.querySelectorAll('video')).map(video=>video.dataset.mediaKey).filter(Boolean));for(const [key,entry] of mediaInflight)if(!desired.has(key)&&!activeKeys.has(key)){entry.controller.abort();mediaInflight.delete(key)}const status=document.querySelector('#preload-status'),update=()=>{const ready=[...desired].filter(key=>mediaCache.has(key)).length;status.textContent=`邻近视频已准备 ${ready}/${desired.size}`};update();for(const [event,view] of unique.values())preloadMedia(event,view).catch(()=>null).finally(update)}
...
function patchCard(node,e){const mine=e.state==='claimed'&&e.claimed_by===whoOrEmpty(),canDecide=mine&&state.tokens[e.event_id];const badge=node.querySelector('[data-role=state]');badge.className=`badge ${e.state}`;badge.textContent=e.state+(e.claimed_by?' / '+e.claimed_by:'');node.querySelector('[data-role=category]').textContent=e.category_label||e.category||'未分类';const severity=node.querySelector('[data-role=severity]');severity.className=`severity ${e.severity||'review'}`;severity.textContent=e.severity_label||e.severity||'需复核';node.querySelector('[data-role=decision]').textContent=e.decision?decisionLabel(e.decision,e):'未提交';node.querySelector('[data-role=version]').textContent=e.version;node.querySelector('.actions').innerHTML=`<button class="claim" data-action="claim" ${e.state==='reviewed'||(e.state==='claimed'&&!mine)?'disabled':''}>${mine?'续期':'领取'}</button>${mine?'<button data-action="release">释放</button>':''}${mediaControls(e)}`;node.querySelectorAll('[data-decision]').forEach(button=>{button.textContent=decisionLabel(button.dataset.decision,e);button.disabled=!canDecide;button.classList.toggle('selected',button.dataset.decision===e.decision)});const textarea=node.querySelector('textarea');textarea.disabled=!canDecide;if(document.activeElement!==textarea&&state.drafts[e.event_id]===undefined)textarea.value=e.note||'';bindCard(node,e);bindGold(node,e,canDecide)}
	function render(){const rows=renderedRows(),container=document.querySelector('#cases');mediaObserver.disconnect();container.innerHTML=rows.length?rows.map(card).join(''):'<div class="empty">当前筛选下没有事件</div>';rows.forEach(e=>patchCard(eventNode(e.event_id),e));observeCards(Array.from(container.querySelectorAll('.case')));updateNavigation();preloadNeighbors()}
	function appendFeed(){const all=visibleRows(),before=Math.min(state.renderLimit,all.length);if(before>=all.length)return;state.renderLimit=Math.min(all.length,state.renderLimit+feedBatchSize);const added=all.slice(before,state.renderLimit),container=document.querySelector('#cases');container.insertAdjacentHTML('beforeend',added.map(card).join(''));added.forEach(e=>{const node=eventNode(e.event_id);patchCard(node,e);mediaObserver.observe(node)});updateNavigation()}
	const feedObserver=new IntersectionObserver(entries=>{if(entries.some(entry=>entry.isIntersecting))appendFeed()},{rootMargin:'1200px 0px'});
function eventStamp(e){return [e.state,e.version,e.claimed_by,e.decision,e.note,e.kind,e.category,e.severity].join('|')}
	function reconcile(events){const previous=new Map(state.events.map(e=>[e.event_id,eventStamp(e)]));state.events=events;const next=renderedRows(),current=Array.from(document.querySelectorAll('.case')).map(node=>node.dataset.id);if(current.length!==next.length||current.some((id,index)=>id!==next[index].event_id)){render();return}next.forEach(e=>{if(previous.get(e.event_id)!==eventStamp(e))patchCard(eventNode(e.event_id),e)});updateNavigation()}
...
async function loadIdentity(){const me=await api('/api/me');state.me=me;if(me.authenticated){reviewer.value=me.display_name;reviewer.readOnly=true;document.querySelector('#logout').hidden=false;document.querySelector('#assign').hidden=me.role!=='admin'}else{reviewer.readOnly=false}}
	document.querySelectorAll('[data-filter]').forEach(button=>button.onclick=()=>{document.querySelectorAll('[data-filter]').forEach(x=>x.classList.remove('active'));button.classList.add('active');state.filter=button.dataset.filter;state.focusIndex=0;state.renderLimit=feedBatchSize;render();scrollTo({top:document.querySelector('main').offsetTop,behavior:'smooth'})});document.querySelector('#kind-filter').onchange=event=>{state.kindFilter=event.target.value;state.focusIndex=0;state.renderLimit=feedBatchSize;render();scrollTo({top:document.querySelector('main').offsetTop,behavior:'smooth'})};document.querySelector('#assign').onclick=async()=>{const button=document.querySelector('#assign'),original=button.textContent;button.disabled=true;button.textContent='分配中…';try{await api('/api/review/assign',{method:'POST',body:'{}'});await refresh()}finally{button.disabled=false;button.textContent=original}};document.querySelector('#refresh').onclick=refresh;reviewer.addEventListener('change',()=>{state.focusIndex=0;state.renderLimit=feedBatchSize;render()});feedObserver.observe(document.querySelector('#feed-sentinel'));loadIdentity().then(refresh).catch(error=>document.querySelector('#sync').textContent=error.message);setInterval(refresh,3000);
</script></body></html>"""
